local bufferline = require 'grayhaven.integrations.bufferline'
local cmp = require 'grayhaven.integrations.cmp'
local colorscheme = require 'grayhaven.colorscheme'
local config = require 'grayhaven.config'
local utils = require 'grayhaven.utils'
local theme = {}
...
function theme.colorscheme()
  if vim.version().minor < 8 then
    vim.notify(
      'Neovim 0.8+ is required for grayhaven colorscheme',
